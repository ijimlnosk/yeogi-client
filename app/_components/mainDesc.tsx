    ...
    return (
        <div className="relative w-full h-[980px] my-[200px]">
            <div className="absolute w-full flex flex-col justify-center items-center font-myeongjo">
                <p className="text-xl xl:text-md text-GREY-80 opacity-50 pb-[20px]">How to use YEOGI</p>
                <p className="text-subTitle xl:text-xxl">
                    <span className="text-BRAND-50">여기</span>에 어떻게 기록하나요?
                </p>
                <p className="font-pretendard text-bg xl:text-md text-center py-[30px]">
