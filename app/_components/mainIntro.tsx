    ...
    return (
        <div className="relative w-full h-fit flex flex-row mb-[181px]">
            ...
            <div className="absolute flex flex-col justify-center items-center w-full h-full z-10 top-[-14%] font-myeongjo">
                <p className="text-xl xl:text-[28px] text-GREY-80 opacity-50">Record Your Trip</p>
                <p className="text-title xl:text-[120px]">여기,</p>
            </div>
            <RightGroup />
            <div className="absolute right-[120px] bottom-0 w-[490px] xl:right-[10px]">
                <p className="font-myeongjo text-[40px] xl:text-[36px] break-keep">
                ...
                <p className="text-lg xl:text-bg break-keep">
