...
const MainIntro = () => {
    return (
        <div className="relative w-full h-fit max-h-[980px] flex flex-row mb-[181px]">
            <LeftGroup />
            ...
            <RightGroup />
            <div className="absolute w-[490px] md:w-[320px] sm:w-[280px] right-[150px] xl:right-[6%] md:right-[6%] sm:right-[8%] bottom-0 md:bottom-[8%] sm:bottom-[12%]">
