    ...
    return (
        <div className="py-[200px] xl:py-[100px]">
            <div className="w-full flex flex-col justify-center items-center">
                <p className="font-myeongjo text-bg xl:text-md text-GREY-50 py-4">Choose your trip style</p>
                <p className="font-myeongjo text-[44px] xl:text-[36px]">
                    <span className="text-BRAND-50 font-nomal">취향</span>에 맞는 여행 기록을 확인하세요.
                </p>
                <p className="text-bg xl:text-md font-normal pt-6 pb-10">
                    여행 취향을 선택해 필요한 기록들을 확인하세요
                </p>
            </div>
            <div className="px-4 flex flex-row w-full justify-center items-center py-14 xl:py-10">
                <div className="flex flex-row w-[1680px] xl:w-[1200px] justify-center items-center gap-5 xl:gap-3">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center">
                                    <p className="w-full flex justify-center text-SYSTEM-white text-bg xl:text-md absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 group-hover:top-[30%] transition-all duration-500">
                                        {value}
                                    </p>
                                    <div className="w-fit text-SYSTEM-white text-bg xl:text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center bottom-0 delay-[300ms] hover:delay-[300ms]">
