...
const TemplateBox = ({ type, isSelected }: TemplateBoxProps) => {
    ...
    return (
        <div
            className={`w-[500px] h-[478px] flex flex-col items-center justify-center border-2 rounded-md hover:cursor-pointer ${isSelected ? "bg-BRAND-05 border-BRAND-50 shadow-lg !important" : "border-ACCENT-fireBush bg-SYSTEM-bone"}`}
        >
